...
curl -o install.sh https://raw.githubusercontent.com/yschutz/MasterClass/master/installation/install.sh
# the configuration files
curl -o CONFIGURATION_FILE https://raw.githubusercontent.com/yschutz/MasterClass/master/installation/CONFIGURATION_FILE
# the user data file
curl -o USER_DATA_FILE https://raw.githubusercontent.com/yschutz/MasterClass/master/installation/USER_DATA_FILE
